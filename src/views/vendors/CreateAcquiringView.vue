...
export default defineComponent({
  ...
  components: {Breadcrumb, MainCard, InputText, Button},
  setup() {
    ...
    return {bank, breadcrumbs, formData, toggleCreateAcquiringHandler};
  }
})
</script>
        ...
        <div class="grid">
          ...
          <div class="col-12">
            <div class="grid">
              ...
              <div class="col-12 md:col-6">
                <span class="p-float-label w-full">
                  <InputText v-model="formData.password" id="password" class="w-full"/>
